...
export default function BattingOrderPicker({ teamName, teamColor, players, onComplete, onReset }: Props) {
          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                fontSize: 15, textTransform: 'uppercase', lineHeight: 1.2,
              }}>
                {p.name.split(',')[0] || p.name.split(' ').pop() || 'Player'}
              </div>

              {/* Number */}
              <div style={{
                fontSize: 12, marginTop: 4,
                color: isAssigned ? 'rgba(255,255,255,.6)' : 'var(--muted)',
              }}>
                #{p.num || '?'}
              </div>
            </div>
